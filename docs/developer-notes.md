...
We use ruff version 0.16.5 in this project currently. This is pinned in CI
(`.github/workflows/test.yml`) and can be installed as a stand-alone binary (see documentation), or via `uv` using:
